...
class BoundingBoxAttachment extends VertexAttachment {
    __init() {this.type = base.AttachmentType.BoundingBox;}
    __init2() {this.color = new base.Color(1, 1, 1, 1);}
...
class ClippingAttachment extends VertexAttachment  {
    __init() {this.type = base.AttachmentType.Clipping;}
    

    // Nonessential.
    /** The color of the clipping polygon as it was in Spine. Available only when nonessential data was exported. Clipping polygons
     * are not usually rendered at runtime. */
    __init2() {this.color = new base.Color(0.2275, 0.2275, 0.8078, 1);} // ce3a3aff
...
class MeshAttachment extends VertexAttachment  {
    __init() {this.type = base.AttachmentType.Mesh;}
    ...
    __init3() {this.tempColor = new base.Color(0, 0, 0, 0);}
...
class PathAttachment extends VertexAttachment {
    __init() {this.type = base.AttachmentType.Path;}
     ...
     * rendered at runtime. */
    __init4() {this.color = new base.Color(1, 1, 1, 1);}
...
class PointAttachment extends VertexAttachment {
    __init() {this.type = base.AttachmentType.Point;}

      

    /** The color of the point attachment as it was in Spine. Available only when nonessential data was exported. Point attachments
     * are not usually rendered at runtime. */
    __init2() {this.color = new base.Color(0.38, 0.94, 0, 1);}
    ...
    computeWorldRotation (bone) {
        const mat = bone.matrix;
        let cos = base.MathUtils.cosDeg(this.rotation), sin = base.MathUtils.sinDeg(this.rotation);
...
class RegionAttachment extends Attachment  {
    __init() {this.type = base.AttachmentType.Region;}
    ...
    __init9() {this.color = new base.Color(1, 1, 1, 1);}
    ...
    __init10() {this.offset = base.Utils.newFloatArray(8);}


    __init11() {this.uvs = base.Utils.newFloatArray(8);}

    __init12() {this.tempColor = new base.Color(1, 1, 1, 1);}
 ...
 */
class SwirlEffect  {
    static __initStatic() {this.interpolation = new base.PowOut(2);}
    ...
    //@ts-ignore
    transform(position, uv, light, dark) {
        let radAngle = this.angle * base.MathUtils.degreesToRadians;
...
class CurveTimeline extends Timeline {
    ...
    constructor (frameCount, bezierCount, propertyIds) {
        ...
        this.curves = base.Utils.newFloatArray(frameCount + bezierCount * 18/*BEZIER_SIZE*/);
    ...
    shrink (bezierCount) {
        ...
        if (this.curves.length > size) {
            let newCurves = base.Utils.newFloatArray(size);
...
class RotateTimeline extends CurveTimeline1  {
    ...
    constructor (frameCount, bezierCount, boneIndex) {
        super(frameCount, bezierCount, Property.rotate + "|" + boneIndex);RotateTimeline.prototype.__init.call(this);        this.boneIndex = boneIndex;
    }
...
class TranslateXTimeline extends CurveTimeline1  {
    ...
    constructor (frameCount, bezierCount, boneIndex) {
        super(frameCount, bezierCount, Property.x + "|" + boneIndex);TranslateXTimeline.prototype.__init3.call(this);        this.boneIndex = boneIndex;
    }
...
class TranslateYTimeline extends CurveTimeline1  {
    ...
    constructor (frameCount, bezierCount, boneIndex) {
        super(frameCount, bezierCount, Property.y + "|" + boneIndex);TranslateYTimeline.prototype.__init4.call(this);        this.boneIndex = boneIndex;
    }
...
class ScaleXTimeline extends CurveTimeline1  {
    ...
    constructor (frameCount, bezierCount, boneIndex) {
        super(frameCount, bezierCount, Property.scaleX + "|" + boneIndex);ScaleXTimeline.prototype.__init6.call(this);        this.boneIndex = boneIndex;
    }
...
class ScaleYTimeline extends CurveTimeline1  {
    ...
    constructor (frameCount, bezierCount, boneIndex) {
        super(frameCount, bezierCount, Property.scaleY + "|" + boneIndex);ScaleYTimeline.prototype.__init7.call(this);        this.boneIndex = boneIndex;
    }
...
class ShearXTimeline extends CurveTimeline1  {
    ...
    constructor (frameCount, bezierCount, boneIndex) {
        super(frameCount, bezierCount, Property.shearX + "|" + boneIndex);ShearXTimeline.prototype.__init9.call(this);        this.boneIndex = boneIndex;
    }
...
class ShearYTimeline extends CurveTimeline1  {
    ...
    constructor (frameCount, bezierCount, boneIndex) {
        super(frameCount, bezierCount, Property.shearY + "|" + boneIndex);ShearYTimeline.prototype.__init10.call(this);        this.boneIndex = boneIndex;
    }
...
class AlphaTimeline extends CurveTimeline1  {
    ...
    constructor (frameCount, bezierCount, slotIndex) {
        super(frameCount, bezierCount, Property.alpha + "|" + slotIndex);AlphaTimeline.prototype.__init13.call(this);        this.slotIndex = slotIndex;
    }
...
class AttachmentTimeline extends Timeline  {
    ...
    apply (skeleton, lastTime, time, events, alpha, blend, direction) {
        ...
        if (time < this.frames[0]) {
            if (blend == exports.MixBlend.setup || blend == exports.MixBlend.first) this.setAttachment(skeleton, slot, slot.data.attachmentName);
            return;
        }
...
class EventTimeline extends Timeline {
    static __initStatic() {this.propertyIds = [ "" + Property.event ];}
...
class DrawOrderTimeline extends Timeline {
    static __initStatic2() {this.propertyIds = [ "" + Property.drawOrder ];}
    ...
    apply (skeleton, lastTime, time, firedEvents, alpha, blend, direction) {
        if (direction == exports.MixDirection.mixOut) {
            if (blend == exports.MixBlend.setup) base.Utils.arrayCopy(skeleton.slots, 0, skeleton.drawOrder, 0, skeleton.slots.length);
            return;
        }

        if (time < this.frames[0]) {
            if (blend == exports.MixBlend.setup || blend == exports.MixBlend.first) base.Utils.arrayCopy(skeleton.slots, 0, skeleton.drawOrder, 0, skeleton.slots.length);
            return;
        }
...
class PathConstraintSpacingTimeline extends CurveTimeline1 {
    ...
    constructor (frameCount, bezierCount, pathConstraintIndex) {
        super(frameCount, bezierCount, Property.pathConstraintSpacing + "|" + pathConstraintIndex);PathConstraintSpacingTimeline.prototype.__init18.call(this);        this.pathConstraintIndex = pathConstraintIndex;
    }
...
class AnimationState  {
    ...
    __init7() {this.propertyIDs = new base.StringSet();}
    __init8() {this.animationsChanged = false;}

    __init9() {this.trackEntryPool = new base.Pool(() => new TrackEntry());}
    ...
    applyRotateTimeline (timeline, skeleton, time, alpha, blend,
        ...
        if (diff == 0) {
            ...
            if (base.MathUtils.signum(lastDiff) != base.MathUtils.signum(diff) && Math.abs(lastDiff) <= 90) {
                ...
                if (Math.abs(lastTotal) > 180) lastTotal += 360 * base.MathUtils.signum(lastTotal);
                dir = current;
            }
            total = diff + lastTotal - lastTotal % 360; // Store loops as part of lastTotal.
            if (dir != current) total += 360 * base.MathUtils.signum(lastTotal);
    ...
    setAnimationByName(trackIndex, animationName, loop) {
     ...
     static __initStatic2() {this.deprecatedWarning2 = false;}
    ...
    addAnimationByName(trackIndex, animationName, loop, delay) {
     ...
     static __initStatic3() {this.deprecatedWarning3 = false;}
...
} AnimationState.__initStatic(); AnimationState.__initStatic2(); AnimationState.__initStatic3();
...
class TrackEntry  {constructor() { TrackEntry.prototype.__init10.call(this);TrackEntry.prototype.__init11.call(this);TrackEntry.prototype.__init12.call(this);TrackEntry.prototype.__init13.call(this); }
     ...
     * called. */
    __init10() {this.mixBlend = exports.MixBlend.replace;}
    ...
    //deprecated stuff
     ...
     static __initStatic4() {this.deprecatedWarning1 = false;}
     static __initStatic5() {this.deprecatedWarning2 = false;}
...
} TrackEntry.__initStatic4(); TrackEntry.__initStatic5();
...
class BoneData {
    ...
    __init8() {this.transformMode = exports.TransformMode.Normal;}
     ...
     * rendered at runtime. */
    __init10() {this.color = new base.Color();}
...
class Bone  {
    ...
    __init17() {this.sorted = false;}
    __init18() {this.active = false;}
    ...
    updateWorldTransformWith (x, y, rotation, scaleX, scaleY, shearX, shearY) {
        ...
        let sy = base.settings.yDown? -this.skeleton.scaleY : this.skeleton.scaleY;
        if (!parent) { // Root bone.
        ...
        switch (this.data.transformMode) {
            case exports.TransformMode.Normal: {
                let rotationY = rotation + 90 + shearY;
                let la = base.MathUtils.cosDeg(rotation + shearX) * scaleX;
                let lb = base.MathUtils.cosDeg(rotationY) * scaleY;
                let lc = base.MathUtils.sinDeg(rotation + shearX) * scaleX;
                let ld = base.MathUtils.sinDeg(rotationY) * scaleY;
                m.a = pa * la + pb * lc;
                m.c = pa * lb + pb * ld;
                m.b = pc * la + pd * lc;
                m.d = pc * lb + pd * ld;
            ...
            case exports.TransformMode.NoRotationOrReflection: {
                ...
                let la = base.MathUtils.cosDeg(rx) * scaleX;
                let lb = base.MathUtils.cosDeg(ry) * scaleY;
                let lc = base.MathUtils.sinDeg(rx) * scaleX;
                let ld = base.MathUtils.sinDeg(ry) * scaleY;
                m.a = pa * la - pb * lc;
                m.c = pa * lb - pb * ld;
                m.b = pc * la + pd * lc;
                m.d = pc * lb + pd * ld;
            ...
            case exports.TransformMode.NoScaleOrReflection: {
                let cos = base.MathUtils.cosDeg(rotation);
                let sin = base.MathUtils.sinDeg(rotation);
                ...
                let zb = Math.cos(r) * s;
                let zd = Math.sin(r) * s;
                let la = base.MathUtils.cosDeg(shearX) * scaleX;
                let lb = base.MathUtils.cosDeg(90 + shearY) * scaleY;
                let lc = base.MathUtils.sinDeg(shearX) * scaleX;
                let ld = base.MathUtils.sinDeg(90 + shearY) * scaleY;
                m.a = za * la + zb * lc;
                m.c = za * lb + zb * ld;
                m.b = zc * la + zd * lc;
                m.d = zc * lb + zd * ld;
    ...
    worldToLocalRotation (worldRotation) {
        let sin = base.MathUtils.sinDeg(worldRotation), cos = base.MathUtils.cosDeg(worldRotation);
        let mat = this.matrix;
    ...
    localToWorldRotation (localRotation) {
        ...
        let sin = base.MathUtils.sinDeg(localRotation), cos = base.MathUtils.cosDeg(localRotation);
        let mat = this.matrix;
    ...
    rotateWorld (degrees) {
        let mat = this.matrix;
        let a = mat.a, b = mat.c, c = mat.b, d = mat.d;
        let cos = base.MathUtils.cosDeg(degrees), sin = base.MathUtils.sinDeg(degrees);
        mat.a = cos * a - sin * c;
        mat.c = cos * b - sin * d;
        mat.b = sin * a + cos * c;
        mat.d = sin * b + cos * d;
    ...
    apply2 (parent, child, targetX, targetY, bendDir, stretch, uniform, softness, alpha) {
        ...
        outer:
            if (u) {
                ...
                let minAngle = base.MathUtils.PI, minX = l1 - a, minDist = minX * minX, minY = 0;
...
class PathConstraint  {
    ...
    update () {
        ...
        let bones = this.bones;
        let spaces = base.Utils.setArraySize(this.spaces, spacesCount), lengths = scale ? this.lengths = base.Utils.setArraySize(this.lengths, boneCount) : null;
    ...
    computeWorldPositions (path, spacesCount, tangents) {
        ...
        let spaces = this.spaces, out = base.Utils.setArraySize(this.positions, spacesCount * 3 + 2), world = null;
        ...
        // Curve lengths.
        let curves = base.Utils.setArraySize(this.curves, curveCount);
        let pathLength = 0;
...
class TransformConstraint  {
    ...
    __init7() {this.temp = new base.Vector2();}
    ...
    applyAbsoluteWorld () {
        ...
        let degRadReflect = ta * td - tb * tc > 0 ? base.MathUtils.degRad : -base.MathUtils.degRad;
...
class Skeleton  {
    ...
    updateWorldTransformWith (parent) {
        ...
        let la = base.MathUtils.cosDeg(rootBone.rotation + rootBone.shearX) * rootBone.scaleX;
        let lb = base.MathUtils.cosDeg(rotationY) * rootBone.scaleY;
        let lc = base.MathUtils.sinDeg(rootBone.rotation + rootBone.shearX) * rootBone.scaleX;
        let ld = base.MathUtils.sinDeg(rotationY) * rootBone.scaleY;
...
class SlotData  {
    ...
    /** The color used to tint the slot's attachment. If {@link #getDarkColor()} is set, this is used as the light color for two
     * color tinting. */
    __init() {this.color = new base.Color(1, 1, 1, 1);}
...
class SkeletonBinary {
    static __initStatic() {this.BlendModeValues = [ constants.BLEND_MODES.NORMAL, constants.BLEND_MODES.ADD, constants.BLEND_MODES.MULTIPLY, constants.BLEND_MODES.SCREEN];}
    ...
    readSkeletonData (binary) {
        ...
        let input = new base.BinaryInput(binary);
        ...
        for (let i = 0; i < n; i++) {
            ...
            if (nonessential) base.Color.rgba8888ToColor(data.color, input.readInt32());
        ...
        for (let i = 0; i < n; i++) {
            ...
            if (darkColor != -1) base.Color.rgb888ToColor(data.darkColor = new base.Color(), darkColor);
        ...
        for (let i = 0, nn; i < n; i++) {
            ...
            if (data.spacingMode == exports.SpacingMode.Length || data.spacingMode == exports.SpacingMode.Fixed) data.spacing *= scale;
            data.mixRotate = input.readFloat();
            data.mixX = input.readFloat();
            data.mixY = input.readFloat();
     ...
     readAttachment(input, skeletonData, skin, slotIndex, attachmentName, nonessential) {
        ...
        switch (input.readByte()) {
            ...
            case base.AttachmentType.BoundingBox: {
                ...
                if (nonessential) base.Color.rgba8888ToColor(box.color, color);
                return box;
            }
            ...
            case base.AttachmentType.Path: {
                ...
                let vertexCount = input.readInt(true);
                let vertices = this.readVertices(input, vertexCount);
                let lengths = base.Utils.newArray(vertexCount / 3, 0);
                ...
                if (nonessential) base.Color.rgba8888ToColor(path.color, color);
                return path;
            }
            case base.AttachmentType.Point: {
                ...
                if (nonessential) base.Color.rgba8888ToColor(point.color, color);
                return point;
            }
            case base.AttachmentType.Clipping: {
                ...
                if (nonessential) base.Color.rgba8888ToColor(clip.color, color);
                return clip;
            }
        }
        return null;
     ...
     readAnimation (input, name, skeletonData) {
                    ...
                    case PATH_SPACING:
                        timelines
                            .push(readTimeline1(input, new PathConstraintSpacingTimeline(input.readInt(true), input.readInt(true), index),
                                data.spacingMode == exports.SpacingMode.Length || data.spacingMode == exports.SpacingMode.Fixed ? scale : 1));
                        break;
                    case PATH_MIX:
        ...
        if (drawOrderCount > 0) {
            ...
            for (let i = 0; i < drawOrderCount; i++) {
                ...
                let drawOrder = base.Utils.newArray(slotCount, 0);
                for (let ii = slotCount - 1; ii >= 0; ii--)
                    drawOrder[ii] = -1;
                let unchanged = base.Utils.newArray(slotCount - offsetCount, 0);
...
function setBezier (input, timeline, bezier, frame, value,
                    time1, time2, value1, value2, scale) {
...
class SkeletonBounds {constructor() { SkeletonBounds.prototype.__init.call(this);SkeletonBounds.prototype.__init2.call(this);SkeletonBounds.prototype.__init3.call(this);SkeletonBounds.prototype.__init4.call(this);SkeletonBounds.prototype.__init5.call(this);SkeletonBounds.prototype.__init6.call(this);SkeletonBounds.prototype.__init7.call(this); }
    ...
    __init6() {this.polygons = new Array();}
     ...
     __init7() {this.polygonPool = new base.Pool(() => {
...
class SkeletonJson {
    ...
    readSkeletonData (json) {
        ...
        if (root.slots) {
            for (let i = 0; i < root.slots.length; i++) {
                ...
                if (dark) data.darkColor = base.Color.fromString(dark);
    ...
    readVertices (map, attachment, verticesLength) {
        ...
        if (verticesLength == vertices.length) {
            let scaledVertices = base.Utils.toFloatArray(vertices);
            if (scale != 1) {
    ...
    readAnimation (map, name, skeletonData) {
                ...
                for (let timelineName in slotMap) {
                    ...
                    if (timelineName == "attachment") {
                        ...
                        for (let frame = 0, bezier = 0;; frame++) {
                            ...
                            let newColor = base.Color.fromString(nextMap.color);
                        ...
                        for (let frame = 0, bezier = 0;; frame++) {
                            ...
                            let time2 = getValue(nextMap, "time", 0);
                            let newColor = base.Color.fromString(nextMap.light);
                            let newColor2 = base.Color.fromString(nextMap.dark);
                            let curve = keyMap.curve;
                            if (curve) {
                                bezier = readCurve(curve, timeline, bezier, frame, 0, time, time2, color.r, newColor.r, 1);
                                bezier = readCurve(curve, timeline, bezier, frame, 1, time, time2, color.g, newColor.g, 1);
        ...
        if (map.drawOrder) {
            ...
            for (let i = 0; i < map.drawOrder.length; i++, frame++) {
                ...
                if (offsets) {
                    ...
                    let unchanged = base.Utils.newArray(slotCount - offsets.length, 0);
                    let originalIndex = 0, unchangedIndex = 0;
        ...
        if (map.events) {
            ...
            for (let i = 0; i < map.events.length; i++, frame++) {
                ...
                let event = new Event(base.Utils.toSinglePrecision(getValue(eventMap, "time", 0)), eventData);
...
function readCurve (curve, timeline, bezier, frame, value, time1, time2,
                    value1, value2, scale) {
    if (curve == "stepped") {
        timeline.setStepped(frame);
        return bezier;
