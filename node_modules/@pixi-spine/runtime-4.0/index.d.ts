 ...
 * @public
 * */
export declare interface AnimationStateListener {
...
export declare abstract class CurveTimeline extends Timeline {
    protected curves: ArrayLike_2<number>;
...
export declare class DeformTimeline extends CurveTimeline implements SlotTimeline {
    ...
    vertices: Array<ArrayLike_2<number>>;
    constructor(frameCount: number, bezierCount: number, slotIndex: number, attachment: VertexAttachment);
    getFrameCount(): number;
    /** Sets the time in seconds and the vertices for the specified key frame.
     * @param vertices Vertex positions for an unweighted VertexAttachment, or deform offsets if it has weights. */
    setFrame(frame: number, time: number, vertices: ArrayLike_2<number>): void;
...
export declare abstract class Timeline {
    ...
    static search1(frames: ArrayLike_2<number>, time: number): number;
    static search(frames: ArrayLike_2<number>, time: number, step: number): number;
}
